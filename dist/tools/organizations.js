...
export function registerOrganizationTools(server) {
    server.registerTool("dual_list_organizations", {
        ...
        try {
            const res = await makeApiRequest("organizations", "GET", undefined, params);
    ...
    server.registerTool("dual_create_organization", {
        ...
        try {
            const res = await makeApiRequest("organizations", "POST", params);
    ...
    server.registerTool("dual_get_organization", {
        ...
        try {
            const res = await makeApiRequest(`organizations/${params.organization_id}`);
            return textResult(JSON.stringify(res, null, 2));
        }
        catch (e) {
            return errorResult(handleApiError(e));
    ...
    server.registerTool("dual_update_organization", {
        ...
        try {
            ...
            const res = await makeApiRequest(`organizations/${organization_id}`, "PUT", body);
    ...
    server.registerTool("dual_get_org_balance", {
        ...
        try {
            const res = await makeApiRequest(`organizations/${params.organization_id}/balance`);
            return textResult(JSON.stringify(res, null, 2));
        }
        catch (e) {
            return errorResult(handleApiError(e));
    ...
    server.registerTool("dual_list_org_members", {
        ...
        try {
            const res = await makeApiRequest(`organizations/${params.organization_id}/members`);
            return textResult(JSON.stringify(res, null, 2));
        }
        catch (e) {
            return errorResult(handleApiError(e));
    ...
    server.registerTool("dual_list_org_roles", {
        ...
        try {
            const res = await makeApiRequest(`organizations/${params.organization_id}/roles`);
            return textResult(JSON.stringify(res, null, 2));
        }
        catch (e) {
            return errorResult(handleApiError(e));
    ...
    server.registerTool("dual_create_org_role", {
        ...
        try {
            const { organization_id, ...body } = params;
            const res = await makeApiRequest(`organizations/${organization_id}/roles`, "POST", body);
