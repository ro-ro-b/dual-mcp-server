...
export function registerPublicApiTools(server) {
    server.registerTool("dual_public_list_templates", {
        ...
        try {
            const res = await makeApiRequest("public/templates", "GET", undefined, params);
    ...
    server.registerTool("dual_public_get_template", {
        ...
        try {
            const res = await makeApiRequest(`public/templates/${params.template_id}`);
            return textResult(JSON.stringify(res, null, 2));
        }
        catch (e) {
            return errorResult(handleApiError(e));
    ...
    server.registerTool("dual_public_get_object", {
        ...
        try {
            const res = await makeApiRequest(`public/objects/${params.object_id}`);
            return textResult(JSON.stringify(res, null, 2));
        }
        catch (e) {
            return errorResult(handleApiError(e));
    ...
    server.registerTool("dual_public_search_objects", {
        ...
        try {
            const res = await makeApiRequest("public/objects/search", "POST", params);
            return textResult(JSON.stringify(res, null, 2));
        }
        catch (e) {
            return errorResult(handleApiError(e));
    ...
    server.registerTool("dual_public_get_stats", {
        ...
        try {
            const res = await makeApiRequest("public/stats");
            return textResult(JSON.stringify(res, null, 2));
        }
        catch (e) {
            return errorResult(handleApiError(e));
